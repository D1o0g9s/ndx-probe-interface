...
# Next Steps for ndx-probe-interface Extension for NWB

## Creating Your Extension

1. In a terminal, change directory into the new ndx-probe-interface directory.
...
`spec/ndx-probe-interface.namespace.yaml` and
`spec/ndx-probe-interface.extensions.yaml` files.
...
2. Start a git repository for your extension directory ndx-probe-interface
...
8. Make a release for the extension on GitHub with the version number specified. e.g. if version is 0.1.0, then this page should exist: https://github.com/d1o0g9s/ndx-probe-interface/releases/tag/0.1.0 . For instructions on how to make a release on GitHub see [here](https://help.github.com/en/github/administering-a-repository/creating-releases).

9. Publish your updated extension on [PyPI](https://pypi.org/).
    - Follow these directions: https://packaging.python.org/tutorials/packaging-projects/
    - You may need to modify `setup.py`
    - If your extension version is 0.1.0, then this page should exist: https://pypi.org/project/ndx-probe-interface/0.1.0
...
`staged-extensions/ndx-probe-interface`:

    ```bash
    cp -r staged-extensions/example staged-extensions/ndx-probe-interface
    ```

13. Edit `staged-extensions/ndx-probe-interface/ndx-meta.yaml`
with information on where to find your NWB extension.
    ...
    - You may copy and modify the following YAML that was auto-generated:
      ...
      version: 0.1.0
      src: https://github.com/d1o0g9s/ndx-probe-interface
      pip: https://pypi.org/project/ndx-probe-interface/
      license: BSD-3
      maintainers: 
        - d1o0g9s
      ```

14. Edit `staged-extensions/ndx-probe-interface/README.md`
to add information about your extension. You may copy it from
`ndx-probe-interface/README.md`.

  ```bash
  cp ndx-probe-interface/README.md staged-extensions/ndx-probe-interface/README.md
  ```

15. Add and commit your changes to Git and push your changes to GitHub.
```
cd staged-extensions
git add ndx-probe-interface
git commit -m "Add new catalog entry for ndx-probe-interface" .
git push
```
...
ndx-probe-interface-record will be created in the nwb-extensions
GitHub organization and you will be added as a maintainer for that repository.


## Updating Your Published Extension

1. Update your ndx-probe-interface GitHub repository.

2. Publish your updated extension on PyPI.

3. Fork the ndx-probe-interface-record repository on GitHub.
